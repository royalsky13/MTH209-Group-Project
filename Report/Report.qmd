...
-   We observed that Karnataka had improved over in cancer eradication whereas Hyderabad plunged to an increment in the number of cancer cases. The Telangana state, formed in $2$ June, $2014$, had a less amount of cancer cases in $2021$. Ladakh was formed as a Union Territory in $31$ October, $2019$. It showed fewer cancer patients in $2021$, possibly due to its smaller population ratio.
...
::: {#fig-2 layout-ncol="2"}
![600 Components](download3.png){#fig-aa}

![400 Components](download4.png){#fig-bb}
