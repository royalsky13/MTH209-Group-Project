...
Null Hypothesis ($\text{H}_0$): The null hypothesis assumes that there is no difference between the means of the "one" group and the means of the "all" group. $$\text{H}_0:\mu_\text{one}=\mu_\text{all}$$

Alternative Hypothesis ($\text{H}_1$): The alternative hypothesis states that the means of the "one" group and the "all" group are different. $$\text{H}_1:\mu_\text{one}\neq\mu_\text{all}$$

Test Statistic: $t = \dfrac{\bar{x_1}-\bar{x_2}}{\sqrt{\dfrac{s_1^2}{n_1}+ \dfrac{s_2^2}{n_2} } }$ where:
